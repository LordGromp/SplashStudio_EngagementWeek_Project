...
#define UE_PROJECT_NAME SplashMechanics
#define UE_TARGET_NAME SplashMechanicsEditor
#define UE_MODULE_NAME "SplashMechanics"
...
#define SPLASHMECHANICS_API DLLEXPORT
